(function(){
    ...
    document.querySelector('.contracted').style.visibility = 'hidden';
    ...
    window.addEventListener('load', function(){
        ...
        api.onUserUpdate(function(username){
            ...
            document.querySelector('.contracted').style.visibility = (username)? 'visible' : 'hidden';
            document.querySelector('.drop-down').style.visibility = (username)? 'visible' : 'hidden';
        });
        ...
        let toggleButton = document.querySelector('.contracted');

        toggleButton.addEventListener('click', function(e){
            let imageForm = document.querySelector('#add_image_form');
            if (imageForm){
                imageForm.id = "hidden_image_form";
                toggleButton.innerHTML = 'Click here to upload your own image!';
            }
            else{
                imageForm = document.querySelector("#hidden_image_form");
                imageForm.id = "add_image_form";
                toggleButton.innerHTML = 'Close the form';
            }

        });
        document.querySelector('.close_button').addEventListener('click', function(e){
            let imageForm = document.querySelector('#add_image_form');
            imageForm.id = "hidden_image_form";
            toggleButton.innerHTML = 'Click here to upload your own image!';
